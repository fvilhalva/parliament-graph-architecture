...
Este capitulo descreve os resultados gerados pelo software da pesquisa, e além disso, as discussões sobre os dados agregados.

\section{VALIDAÇÃO DA ARQUITETURA E REPRODUTIBILIDADE}

A arquitetura foi testada e validada por meio testes unitarios por módulo do software, 
