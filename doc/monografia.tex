...
\begin{figure}[H]
    ...
    \begin{minipage}{0.48\textwidth}
        \centering
        \includegraphics[width=\linewidth]{imagens/resultados/gephi/rede-comunidades-2025-01.png}
        \\{\small (a) Cor por comunidade (Louvain)}
    \end{minipage}
    \hfill
    \begin{minipage}{0.48\textwidth}
        \centering
        \includegraphics[width=\linewidth]{imagens/resultados/gephi/rede-partidos-2025-01.png}
