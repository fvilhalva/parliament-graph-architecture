...
\label{cap:revisao}
    ...
    A Figura~\ref{fig:juncao_dados} ilustra as fases das operações. O cruzamento
...
\end{lstlisting}
    ...
    executam os 153 testes restantes; a cobertura de 83\% pressupõe, portanto, os
