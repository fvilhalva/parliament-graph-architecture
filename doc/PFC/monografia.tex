...
\label{cap:revisao}
    ...
    Como ilustrado no framework clássico de \citeonline{hevner2004} (Figura~\ref{fig:dsr_framework}), a condução desta pesquisa estabelece uma sinergia entre três domínios fundamentais:
    \begin{itemize}
...
\end{lstlisting}
    ...
    integridade dependem dos artefatos de dados: só executam após o pipeline gerar o
